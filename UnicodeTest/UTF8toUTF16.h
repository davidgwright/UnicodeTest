...
//—————————————————————————-
CStringW ConvertUTF8ToUTF16( __in const TCHAR * pszTextUTF8 )
{
    //
    // Special case of NULL or empty input string
    //
    if ( (pszTextUTF8 == NULL) || (*pszTextUTF8 == CString("")) )
    {
        // Return empty string
        return L"";
    }
    ...
    size_t cchUTF8;
    HRESULT hr = ::StringCchLengthW( pszTextUTF8, cchUTF8Max, &cchUTF8 );
    if ( FAILED( hr ) )
    {
        AtlThrow( hr );
    }
...
CStringA ConvertUTF16ToUTF8( __in const WCHAR * pszTextUTF16 )
{
    ...
    // Special case of NULL or empty input string
    //
    if ( (pszTextUTF16 == NULL) || (*pszTextUTF16 == CString( L"" )) )
    {
        // Return empty string
        return "";
    }
